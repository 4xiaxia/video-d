...
import type { BoardStageToolMode, StageRecordingCanvases } from '../components/drawboardStageTypes';
import type { BoardClipPatch } from '../components/drawboardStageTypes';
