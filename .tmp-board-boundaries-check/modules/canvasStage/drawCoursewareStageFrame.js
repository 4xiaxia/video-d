...
import { COURSEWARE_LABEL_HEIGHT_RATIO, COURSEWARE_LABEL_LEFT_RATIOS, COURSEWARE_LABEL_TOP_RATIOS, COURSEWARE_LABEL_WIDTH_RATIO, COURSEWARE_PROBLEM_LEFT_RATIO, COURSEWARE_PROBLEM_MAX_WIDTH_RATIO, COURSEWARE_PROBLEM_TOP_RATIO, COURSEWARE_SYSTEM_FONT_FAMILY, resolveProblemFontSize, } from './coursewareChrome';
const LABEL_BG = '#59cee5';
const LABEL_TEXT = '#ffffff';
const PROBLEM_TEXT = '#243247';
const FRAME_STROKE = '#59cee5';
export function drawCoursewareStageFrame(context, canvas, problemSummary = '') {
    context.save();
...
function drawCoursewareFrameChrome(context, canvas) {
    // 边框
...
function drawLabel(context, canvas, text, leftRatio, topRatio) {
...
function drawProblemSummary(context, canvas, problemSummary) {
