import { DEFAULT_BOARD_DRAW_SPEED } from './boardRevealConfig.js';
export function getBoardRevealProgress({ drawSpeed, playheadMs, revealEndMs, revealStartMs, }) {
    if (!Number.isFinite(playheadMs)) {
        return 0;
    }
    if (typeof revealStartMs !== 'number' ||
...
function shapeBoardRevealProgress(progress) {
