...
const mathStickerImageCache = new Map();
...
export async function renderBoardMathStickerImage(text, options = {}) {
...
function buildBoardMathHtml(text) {
...
function buildSvgFromProbe(innerHtml, width, height, options) {
    const style = [
        'display:inline-grid',
        'gap:4px',
        'box-sizing:border-box',
...
function manageCache(result, cacheKey) {
