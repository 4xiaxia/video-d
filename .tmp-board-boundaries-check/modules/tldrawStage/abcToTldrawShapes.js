...
import { DEFAULT_BOARD_STICKER_WIDTH_PERCENT, DEFAULT_BOARD_STICKER_X_PERCENT, DEFAULT_BOARD_STICKER_Y_PERCENT, getBoardStickerFontSize, } from '../boardSticker';
...
export function syncAbcStageToTldraw({ canvas, editor, playheadMs, problemText, boardClips, }) {
...
export function resolveTldrawStageSize(canvas) {
...
function resolveTldrawTextSize(fontSize) {
    if (fontSize >= 46)
        return 'xl';
    if (fontSize >= 34)
        return 'l';
