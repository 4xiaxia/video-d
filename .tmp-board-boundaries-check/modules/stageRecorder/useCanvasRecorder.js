...
export function useCanvasRecorder() {
    ...
    /** 开始 canvas 合成录制 */
    const startRecording = async (baseCanvas, contentCanvas, overlayCanvas) => {
        if (status === 'recording') {
            return;
        }
        if (!baseCanvas) {
...
function appendActiveVoiceAudioTracks(videoStream) {
...
function readMediaElementCaptureStream(audio) {
